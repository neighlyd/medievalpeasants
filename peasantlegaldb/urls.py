...
person_detail_urls = [
    url(r'^(?P<pk>\d+)/$', views.PersonDetailView.as_view(template_name='person/_person_detail.html'),
        name='detail'),
    url(r'^(?P<pk>\d+)/amercement_list', views.PersonDetailView.as_view(template_name='person/amercement_list.html'),
        name='amercements'),
    url(r'^(?P<pk>\d+)/case_list', views.PersonDetailView.as_view(template_name='person/case_list.html'),
        name='cases'),
    url(r'^(?P<pk>\d+)/capitagium_list', views.PersonDetailView.as_view(template_name='person/capitagium_list.html'),
        name='capitagia'),
    url(r'^(?P<pk>\d+)/damage_list', views.PersonDetailView.as_view(template_name='person/damage_list.html'),
        name='damages'),
    url(r'^(?P<pk>\d+)/fine_list', views.PersonDetailView.as_view(template_name='person/fine_list.html'),
        name='fines'),
    url(r'^(?P<pk>\d+)/heriot_list', views.PersonDetailView.as_view(template_name='person/heriot_list.html'),
        name='heriots'),
    url(r'^(?P<pk>\d+)/impercamentum_list', views.PersonDetailView.as_view(template_name='person/impercamentum_list.html'),
        name='impercamenta'),
    url(r'^(?P<pk>\d+)/land_list', views.PersonDetailView.as_view(template_name='person/land_list.html'),
        name='lands'),
    url(r'^(?P<pk>\d+)/pledges', views.PersonDetailView.as_view(template_name='person/pledges_list.html'),
        name='pledges'),
    url(r'^(?P<pk>\d+)/position_list', views.PersonDetailView.as_view(template_name='person/position_list.html'),
        name='positions'),
    url(r'^(?P<pk>\d+)/relationship_list', views.PersonDetailView.as_view(template_name='person/relationship_list.html'),
        name='relationships'),
...
village_urls = [
    ...
    url(r'^(?P<pk>\d+)/resident_list$', views.PersonDetailView.as_view(template_name='village/resident_list.html'),
        name='residents'),
    url(r'^(?P<pk>\d+)/session_list.html$', views.SessionListView.as_view(template_name='village/session_list.html'),
        name='sessions'),
