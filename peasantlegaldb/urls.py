...
person_detail_urls = [
    ...
    url(r'^(?P<pk>\d+)/case_list', views.PeopleListView.as_view(template_name='person/person_case_list.html'),
        name='cases'),
    url(r'^(?P<pk>\d+)/pledge_list', views.PeopleListView.as_view(template_name='person/pledge_list.html'), name='pledges'),
    url(r'^(?P<pk>\d+)/relationship_list', views.PeopleListView.as_view(template_name='person/relationship_list.html'),
        name='relationships'),
    url(r'^(?P<pk>\d+)/position_list', views.PeopleListView.as_view(template_name='person/position_list.html'),
        name='positions'),
    url(r'^(?P<pk>\d+)/land_list', views.PeopleListView.as_view(template_name='person/person_land_history_list.html'),
        name='lands'),
    url(r'^(?P<pk>\d+)/stats', views.PersonDetailView.as_view(template_name='person/person_stats.html'), name='stats'),
    url(r'^(?P<pk>\d+)/amercement_list', views.PersonDetailView.as_view(template_name='person/person_amercement_cases.html'),
        name='amercements'),
    url(r'^(?P<pk>\d+)/fine_list', views.PersonDetailView.as_view(template_name='person/person_fine_cases.html'),
        name='fines'),
    url(r'^(?P<pk>\d+)/damage_list', views.PersonDetailView.as_view(template_name='person/person_damage_cases.html'),
        name='damages'),
    url(r'^(?P<pk>\d+)/chevage_list', views.PersonDetailView.as_view(template_name='person/person_chevage_cases.html'),
        name='chevages'),
    url(r'^(?P<pk>\d+)/impercamentum_list', views.PersonDetailView.as_view(
        template_name='person/person_impercamentum_cases.html'), name='impercamenta'),
    url(r'^(?P<pk>\d+)/heriot_list', views.PersonDetailView.as_view(template_name='person/person_heriot_cases.html'),
        name='heriots'),
